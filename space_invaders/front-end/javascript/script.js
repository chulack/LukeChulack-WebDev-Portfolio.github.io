...
document.addEventListener("DOMContentLoaded", () => {
    ...
    let current_ufo_index = 0;
    let current_ufo_take_down = [];
    ...
    let kill_bullet = 0;
    let shooter_id;
    let bullet_sound = new Audio("front-end/media/audio/sounds/shoot.wav");
    let alien_move = new Audio("front-end/media/audio/sounds/fastinvader1.wav");
    let alien_killed = new Audio("front-end/media/audio/sounds/invaderkilled.wav");
    let shooter_killed = new Audio("front-end/media/audio/sounds/explosion.wav");
...
const shoot = (e) => {
    ...
    const move_bullet = () => {
        ...
        if(squares[current_bullet_index].classList.contains("invader")) {        
            ...
            squares[current_bullet_index].classList.add("died_invader");
            alien_killed.play();
            setTimeout(() => squares[current_bullet_index].classList.remove("died_invader"), 250);
